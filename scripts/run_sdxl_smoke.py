...
Usage:
    python scripts/run_sdxl_smoke.py
    python scripts/run_sdxl_smoke.py --model_name path/to/sdxl
"""
...
def main():
    ...
    parser.add_argument("--output_dir", type=str, default="outputs/sdxl_smoke")
    ...
    print(f"=== SDXL Smoke Test ({len(SMOKE_PROMPTS)} prompts × {len(experiments)} configs) ===")
    ...
    print("=" * 60)
    print()
    print("=== All SDXL smoke tests passed! ===")
